...
import ec.edu.espam.api.examen.domain.dto.CourseDto;
...
@AutoConfigureMockMvc
 public class CourseControllerTest {
    ...
    void testCreateCourse() throws Exception {
        ...
        courseDto.setName("Course One");
        courseDto.setDescription("This is course one.");
        courseDto.setCreationdate(LocalDate.now());
